    ...
    <section className=" bg-bolinha relative ">
      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-8 sm:mb-16 text-orange-400 leading-tight">
          ...
          <div className="relative w-full max-w-3xl mx-auto mb-8 sm:mb-16 transform -rotate-3">
            <div className="aspect-[3/1] relative">
              <Image
                ...
                fill
                className="object-cover rounded-lg border-4 border-orange-400"
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 max-w-4xl mx-auto">
            {/* Left Column */}
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-orange-400 mb-6 sm:mb-8">
                As franquias apresentam?
              </h3>
              <ul className="space-y-4 sm:space-y-6">
                <li className="flex items-start gap-3">
                  <span className="mt-2.5 block w-2 h-2 rounded-full bg-orange-400 flex-shrink-0" />
          ...
          <div className="mt-12 sm:mt-16 text-center">
            ...
            <Button 
              className="w-full sm:w-auto bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 text-white shadow-xl transform hover:scale-105 transition-all text-lg sm:text-xl py-4 sm:py-6 px-6 sm:px-12 rounded-xl button-blink"
              size="lg"
